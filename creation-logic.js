...
var carsonStory = 'With the firefly\'s fate sealed, ' + localStorage.user.character + ' continued to stroll down the dimly lit street. Each step seemed to crash loudly in the muggy, still air, shattering the silence. Unusually quiet tonight, thought ' + localStorage.user.character + '. ' + localStorage.user.genderType[3] + ' eyes drifted upwards. Amidst the large rolling clouds staining the night sky, the moon seemed brighter now, teeming with what seemed to be a red glow. ' + '\n' + '\n' + 'An uneasy sensation broke ' + localStorage.user.character + '\'s gaze. ' + localStorage.user.genderType[3] + '  eyes darted toward the street as a sense of danger washed over ' + localStorage.user.genderType[2] + '. All of a sudden ' + localStorage.user.genderType[0] + '  got the sense that ' + localStorage.user.genderType[0] + '  was being watched. ' + localStorage.user.character + ' quickened ' + localStorage.user.genderType[2] + '  pace as ' + localStorage.user.genderType[0] + '  neared the trail entrance.' + '\n' + '\n' + 'Tall trees stretched above ' + localStorage.user.genderType[2] + '  as ' + localStorage.user.genderType[0] + '  walked upon the forest floor like giants in the darkness, when a patch of moonlight poking through the trees revealed something profound. ' + localStorage.user.character + ' stood over a moonlit tree stump with a small dagger sitting on top of it.' + '\n' + '\n' + 'CTHULHU WAITS whispered throughout the trees surrounding ' + localStorage.user.name + '...';

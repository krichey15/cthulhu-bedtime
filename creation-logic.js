...
ChoiceOne = localStorage.user.character + ' takes the dagger, feeling a rush of energy flow throughout THEIR body.';
ChoiceTwo = 'Feeling too uneasy about blade before ' + localStorage.user.genderType[] + ' , ' + localStorage.user.character + ' turns away from the artifact and continues along the trail.’;

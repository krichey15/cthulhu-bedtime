...
function storyTime(character, genderType){
  var raeStory = 'Dear Cthulhu, I have many urges and desires, but on this most sacred of nights, there is only one thing that I want. I cannot commit my request to digital media, but please look into my heart of hearts and grant my dearest wish. And I would also like a pony. Yours Truly, ' + character + '<br />' + '<br />' + character + ' finished ' + genderType[2] + ' letter, and with a shaking hand, clicked the send button. ' + character + ' waited several seconds, unsure if ' + genderType[0] + ' would ever receive a response to ' + genderType[2] + ' request, but knew that in the end, if ' + genderType[2] + ' wish was granted, the results would be obvious. ' + character + ' stood, stretching, sore from sitting for so long in front of ' + genderType[2] + ' computer. ' + genderType[1] + ' glanced out the window, squinting at the ominously bright moon. It\'s a good time for a walk, ' + character + ' thought. ' + genderType[1] + ' put on ' + genderType[2] + ' shoes, grabbed a fresh-baked cinnamon roll, and headed out the door, into the night. It was warm and muggy, fireflies glowing in the air. ' + character + ' held out ' + genderType[2] + ' hands, catching one of the bioluminescent bugs. ' + genderType[1] + '…';

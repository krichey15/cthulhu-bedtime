...
function createCharacter(event) {
  ...
  var otherArray = ['they', 'They', 'their', 'Their'];
...
function storyTime(character, genderType){
  ...
  var kyleStory = 'With fear pouring over ' + genderType[2] + ' body, ' + character + ' felt like ' + genderType[0] + ' had no choice but to continue deeper into the woods. With every single step a new horror would appear in ' + character + '\'s mind. Flashes of every fear ' + genderType[0] + ' ever had, appeared so real in these woods. ' + character + '\'s mother brutally murdered. Spiders crawling out of all the trees and up ' + genderType[2] + ' body. Giant rubber ducks surrounding them. It took everything ' + character + ' had to keep going while ' + genderType[2] + ' fears kept creeping in. ' + '<br />' + '<br />' + 'Finally at the end of the path ' + character + ' came across an empty patch of what just seemed like pure darkness. A noise pierced the silence…' + '<br />' + '<br />' + 'NEIGH...' + '<br />' + '<br />' + 'It was a horse, all that for a horse. Wait not a horse! A Pony!!!!! ' + character + ' was filled with pure joy!!' + '<br />' + '<br />' + 'Cthulhu\’s voice broke the joy: “What deal are you willing to make for this?”';
  ...
  localStorage.setItem('goodEnd', character + ' turns and throws the jar full of fireflies at Cthulhu…it shatters. If you were there and listened close you would be able hear the fireflies shout \“FREEDOM!\”. As ' + character + ' rides into the darkness on ' + genderType[2] + ' new pony, Cthulhu stands in awe and whispers \“Man, what a badass\”.');

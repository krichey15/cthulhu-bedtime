...
function storyTime(character, genderType){
  ...
  localStorage.setItem('badEnd', 'Cthulhu smiled. Maybe.' + '<br />' + '\“I will grant your wish, ' + character + '. Take this pony, secure in the knowledge that entropy will reign.\”' + '<br />' + character + ', pure joy shining on ' + genderType[2] + ' face, led ' + genderType[2] + ' pony from the dark clearing, finally eating ' + genderType[2] + ' cinnamon roll as ' + genderType[0] + ' strolled along the moonlit path. It was all worth it, ' + character + ' thought to themselves.' + '<br />' + 'Then ' + genderType[0] + ' died from cinnamon roll poisoning.' + '<br />' + 'And then the heat-death of the universe happened sometime later.' + '<br />' + 'GO CHAOS!');
  localStorage.setItem('neutEnd', 'Before THEY can do anything or say a word, Cthulhu shakes and head and mutters Wait wait... sigh... are you even really into this? NAME, caught off guard, stares at Cthulhu, who is now shrugging. Confused and slightly off put, NAME furrows THEIR brow with THEIR mouth agape racing to comprise a response. Oh what, youre all confused now? Like you didnt write me a letter like 30 minutes ago and then see a series of three very distinct and obvious tasks to prove your undying loyalty to me? asked Cthulhu, Because, like, you didnt even do them all dude! Like I had to move things around to come up here - not a short commute by the way - and I just kinda feel like you shit all over it. NAME, still confused, responds No no! I- Im sorry Cth- What, you think random mystical choices just throw themselves together? Huh? Well they DONT. Fireflys arent even native to this state! I mean seriously I even brought you a pony! And this is how you do us, neutral mcneutralface? Cthulhu said, cutting THEM off and now pointing to the horse. THEIR eyes glance over at the pony, who somehow looks sad too. You think ponies are cheap? Like I just waltzed on down to the free pony store NO I PAID IN ADVANCE DICK. said Cthulhu, leaning forward and then turning away with his hands on his hips. NAME looked down towards the ground, sulking. Im sorry, I didnt think tha- No youre totally right, you DIDNT think. Cthulhu said grabbing the ponys reigns. NEIGH NEI- No dont neigh for THEM Frank, dont neigh for that jerk. Were going home. But first... All of a sudden the sweet pastry NAME had been saving floated from THEIR pocket and over to Cthulhus outstretched hand. Consider this asshole tax, poser. said Cthulhu before stepping in to a dark portal and disappearing with Frank.');
